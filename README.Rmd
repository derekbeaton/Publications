...
Partial least squares correspondence analysis and materials associated with the *PsyMet* paper.

[You can find the PLSCA materials here.](./PsyMet_2015)

## CSDA (ExPosition)

Materials for the original ExPosition paper (which introduces the ideas behind the software and the software itself).
